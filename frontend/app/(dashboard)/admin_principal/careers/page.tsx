...
import { ICareerInfo, setCareerInfos,setSelectedCareerInfo } from "@/src/store/slice/careerInfoSlice";
...
const { data: dataCareerInfo } = useGetAllCareerInfosQuery();
  ...
  const filtered = careerInfos.filter(
    (o) =>
      o.title.toLowerCase().includes(search.toLowerCase()) ||
      o.year.toLowerCase().includes(search.toLowerCase()),
  );
  ...
  const deleteOffer = (id: string) =>
    setCareerInfoss((prev) => prev.filter((o) => o._id !== id));
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Gérez vos offres d'emploi disponibles
          </p>
        </div>
        ...
        <div className="flex gap-3 items-center">
          ...
          <Button
            onClick={() => router.push("/admin/addcareers")}
          ...
          {currentItems.map((o) => (
            ...
            >
              ...
              <div>
                ...
                {/* <p className="text-sm text-gray-500">{o.department}</p> */}
              </div>
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
                ...
                <div className="flex gap-3">
                 ...
                 onClick={()=>router.push(`/admin_principal/careers/${o._id}`)}
                 >
